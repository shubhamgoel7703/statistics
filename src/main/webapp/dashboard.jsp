...
<script src="https://code.highcharts.com/highcharts-more.js"></script> 
 <link href="js/demoCharts.js" rel="stylesheet">
  ...
  <input id="ase" value="<bean:write name="DashDataForm" property="aseCountPercentage" />" style="display:none"> 
   <input id="am" value="<bean:write name="DashDataForm" property="amCount" />" style="display:none"> 
    <input id="m" value="<bean:write name="DashDataForm" property="mCount" />" style="display:none"> 
     <input id="se" value="<bean:write name="DashDataForm" property="seCount" />" style="display:none"> 
      <input id="sm" value="<bean:write name="DashDataForm" property="smCount" />" style="display:none"> 
       <input id="sexec" value="<bean:write name="DashDataForm" property="sExecCount" />" style="display:none"> 
        <input id="sse" value="<bean:write name="DashDataForm" property="sseCount" />" style="display:none"> 
         <input id="tl" value="<bean:write name="DashDataForm" property="tlCount" />" style="display:none"> 
          <input id="EmpCountChange" value="<bean:write name="DashDataForm" property="empCountChange" />" style="display:none"> 
           <input id="AseCountChange" value="<bean:write name="DashDataForm" property="aseCountChange" />" style="display:none"> 
            <input id="AsePlusSeCountChange" value="<bean:write name="DashDataForm" property="asePlusSeCountChange" />" style="display:none"> 
           <input id="GcpCountChange" value="<bean:write name="DashDataForm" property="gcpCountChange" />" style="display:none"> 
           <input id="LoanedCountChange" value="<bean:write name="DashDataForm" property="loanResourceChange" />" style="display:none"> 
           <input id="DiversityPercentageChange" value="<bean:write name="DashDataForm" property="diversityRatioChange" />" style="display:none"> 
           
         
           
 <%--   <input id="data11" value="<bean:write name="DashDataForm" property="data1" />" style="display:none"> 
   --%>
...
<div class="col-md-6 " style="border: 0px;">
            ...
            <div class="col-md-3 tile_stats_count" align="center" >
              <span class="count_top" ><i class="fa fa-user"></i> Total Employees</span>
              <div class="count"><bean:write name="DashDataForm" property="empCount" /></div>
              <div class="dropdown">
             
              
              <span class="count_bottom"><i id="totalEmpChangeColor" ><i id="totalEmpChangelogo"></i><bean:write name="DashDataForm" property="empCountChange" />% </i> From last Week</span>
             ...
             <div   class="dropdown-content" >
              ...
              <table style="width:100%" >
   						...
   						<jstlcore:forEach items="${list}" var="event"  >
							<tr align="center">
							
							<td align="center"><a><i class="green"><jstlcore:out value="${event.empAdd}"></jstlcore:out></i></a></td>
							<td align="center"><a><i class="red"><jstlcore:out value="${event.empSub}"></jstlcore:out></i></a></td>
							</tr>
						</jstlcore:forEach>
       ...
       <!--    <br>  cvfcfc <br> hjh <br><br><br> -->
              </div>             
            </div>
            
            <div class="col-md-3 tile_stats_count" align="center">
              <span class="count_top"><i class="fa fa-clock-o"></i> ASE Count</span>
              <div class="count"><bean:write name="DashDataForm" property="aseCountPercentage" />%<font size="4" >(<bean:write name="DashDataForm" property="aseCount" />)</font></div>
               <div class="dropdown">
              <span class="count_bottom"><i id="aseChangeColor"><i id="aseChangelogo"></i><bean:write name="DashDataForm" property="aseCountChange" />% </i> From last Week</span>
            
            <div class="dropdown-content">
   			<table style="width:100%">
  			<tr>
 			  <td><a><i class="green">ASE Count up : <bean:write name="DashDataForm" property="aseCountUp" /> </i></a></td>
 			 </tr>
 			 <tr>
 			<td><a><i class="red">ASE Count down :  <bean:write name="DashDataForm" property="aseCountDown" /></i></a></td>
			 </tr>
			<tr>
 			  <td><a><i class="green">other Count up :  <bean:write name="DashDataForm" property="other1Up" /></i> </a></td>
 			 </tr>
 			 <tr>
 			<td><a><i class="red">other Count down :  <bean:write name="DashDataForm" property="other1Down" /></i></a></td>
			 </tr>
			</table>
            ...
            <div class="col-md-3 tile_stats_count" align="center">
              <span class="count_top"><i class="fa fa-user"></i> ASE + SE</span>
              <div class="count "><bean:write name="DashDataForm" property="asePlusScPer" />%<font size="4">(<bean:write name="DashDataForm" property="asePlusScCount" />)</font></div>
             <div class="dropdown">
              <span class="count_bottom"><i id="asePlusSeChangeColor"><i id="asePlusSeChangelogo"></i><bean:write name="DashDataForm" property="asePlusSeCountChange" />% </i> From last Week</span>
           
            <div class="dropdown-content">
   			<table style="width:100%">
  			<tr>
 			  <td><a><i class="green">ASE+SE Count up : <bean:write name="DashDataForm" property="asePlusSeCountUp" /> </i></a></td>
 			 </tr>
 			 <tr>
 			<td><a><i class="red">ASE+SE Count down : <bean:write name="DashDataForm" property="asePlusSeCountDown" /> </i></a></td>
			 </tr>
			<tr>
 			  <td><a><i class="green">other Count up : <bean:write name="DashDataForm" property="other2Up" /></i> </a></td>
 			 </tr>
 			 <tr>
 			<td><a><i class="red">other Count down : <bean:write name="DashDataForm" property="other2Down" /> </i></a></td>
			 </tr>
			</table>
              ...
              <div class="col-md-3 tile_stats_count" align="center">
              <span class="count_top"><i class="fa fa-user"></i> GCP Count</span>
              <div class="count"><bean:write name="DashDataForm" property="gcpCountPercentage" />%<font size="4">(<bean:write name="DashDataForm" property="gcpCount" />)</font></div>
              <div class="dropdown">
              <span class="count_bottom"><i id="gcpChangeColor"><i id="gcpChangelogo"></i><bean:write name="DashDataForm" property="gcpCountChange" />% </i> From last Week</span>
           ...
           <div class="dropdown-content">
            ...
            <div class="col-md-6 tile_stats_count" style="border: 0px;"  >
            
            
            
            
             <div class="col-md-3 tile_stats_count" align="center">
              <span class="count_top"><i class="fa fa-user"></i> Diversity Ratio</span>
              <div class="count"><i class="fa fa-female">&nbsp;</i><bean:write name="DashDataForm" property="femaleCount" />:<bean:write name="DashDataForm" property="maleCount" />&nbsp;<i class="fa fa-male"></i></div>
                <div class="dropdown">
               <span class="count_bottom"><i id="diversityChangeColor"><i id="diversityChangelogo"></i><bean:write name="DashDataForm" property="diversityRatioChange" />% </i> From last Week</span>
             <div class="dropdown-content">
   			<table style="width:100%">
  			<tr>
 			  <td><a><i class="green">Female Count up : <bean:write name="DashDataForm" property="femaleCountUp" /></i></a></td>
 			 </tr>
 			 <tr>
 			<td><a><i class="red">Female Count down :<bean:write name="DashDataForm" property="femaleCountDown" /> </i></a></td>
			 </tr>
			<tr>
 			  <td><a><i class="green">Male Count up :<bean:write name="DashDataForm" property="maleCountUp" /></i> </a></td>
 			 </tr>
 			 <tr>
 			<td><a><i class="red">Male Count down : <bean:write name="DashDataForm" property="maleCountDown" /></i></a></td>
			 </tr>
			</table>
            ...
            <div class="col-md-3 tile_stats_count" align="center">
              <span class="count_top"><i class="fa fa-user"></i> Loan Resources</span>
              <div class="count"><bean:write name="DashDataForm" property="loanedResourceCount" /></div>
               <div class="dropdown">
              <span class="count_bottom"><i id="loanChangeColor"><i id="loanChangelogo"></i><bean:write name="DashDataForm" property="loanResourceChange" /> </i> From last Week</span>
           
           <div class="dropdown-content">
   			
              <table style="width:100%" >
             
   						<jstlcore:forEach items="${addList}" var="item"  >
							<tr align="center">
								
							<td align="center"><a><i class="red"><jstlcore:out value="${item}"></jstlcore:out></i></a></td>
							
							</tr>
						</jstlcore:forEach>
						
						<jstlcore:forEach items="${subList}" var="item"  >
							<tr align="center">
								
							<td align="center"><a><i class="green"><jstlcore:out value="${item}"></jstlcore:out></i></a></td>
              ...
              <div class="col-md-3 tile_stats_count" align="center">
              <span class="count_top"><i class="fa fa-user"></i> Non Billable</span>
              <div class="count">1,225</div>
               <div class="dropdown">
           ...
           <div class="dropdown-content">
   			<!-- <table style="width:100%">
  			<tr>
 			  <td><a href="www.google.com">Jill</a></td>
 			 </tr>
 			 <tr>
 			 <td><a href="http://www.w3schools.com/html/">Visit our HTML tutorial</a></td>
			 </tr>
             ...
             <div class="col-md-3 tile_stats_count" align="center" >
              <span class="count_top" ><i class="fa fa-user"></i> Turn Over(oct-dec)</span>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Turn Over & Attrition <small></small></h3>
                  </div>
                   <div class="col-md-6">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  <div style="width: 100%;">
                    <div id="graph" class="demo-placeholder" style="width: 100%; height:270px;"></div>
                  </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Other job </p>
                            </td>
                            <td>${OJP}%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>HS</p>
                            </td>
                           <td>${HSP}%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>LC </p>
                            </td>
                            <td>${LCP}%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>PI </p>
                            </td>
                            <td>${PIP}%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square red"></i>Health </p>
                            </td>
                            <td>${HIP}%</td>
                          </tr>
                        </table>
                ...
                <div class="x_content">
                  <table class="" style="width:100%">
                    ...
                    <tr>
                      ...
                      <div align="center" id="chart-container">FusionCharts will render here</div>  
                      </td>
                ...
                <div class="x_content">
                  <table class="" style="width:100%">
                    ...
                    <tr>
                     ...
                     <div align="center" class="scatterGraphSize " id="scatterGraph" ></div> 
...
var row = name.toString();
    ...
    var t = document.createTextNode("df");
    z.appendChild(t);
...
<!-- Turn over & attrition graph Script -->


<script type="text/javascript" >
 $(function () {
	 var dataAC = ${AttritionCountList};
	 var dataAP=${AttritionPercentageList};
	 var dataTOC=${TurnOverCountList};
	 var dataTOP=${TurnOverPercentageList};
	    ...
	    $('#graph').highcharts({
	        ...
	        series: [{
	         ...
	         tooltip: {
	            ...
	            type: 'column',
	            yAxis: 1,
	           // data: [40.9, 61.5, 86.4, 90.2, 44.0, 76.0, 35.6, 18.5, 219.4, 194.1, 195.6, 154.4],
	        	data: dataAC,
	           tooltip: {
	                valueSuffix: ' '
	            }
	            ...
	            type: 'spline',
	          //  yAxis: 2,
	           // data:[8.0, 5.9, 10.5, 13.5, 19.2, 20.5, 24.2, 25.5, 22.3, 19.3, 14.9, 10.6],
	           	data:dataTOP,
	           /*  marker: {
	                enabled: false
	            }, */
  ...
  <!--   <script src="jquery/jquery.min.js"></script> -->
    ...
    <script src="jquery/bootstrap-progressbar.min.js"></script>
    <!-- iCheck -->
    <script src="jquery/icheck.min.js"></script>
    <!-- Skycons -->
    <script src="jquery/skycons.js"></script>
    <!-- Flot -->
    <script src="jquery/jquery.flot.js"></script>
    <script src="jquery/jquery.flot.pie.js"></script>
    <script src="jquery/jquery.flot.time.js"></script>
    <script src="jquery/jquery.flot.stack.js"></script>
    <script src="jquery/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
   ...
   <!--  <script>
      $(document).ready(function() {
       ...
       var list=   ${data1} ;//request.getAttribute("data1"); //document.getElementById("data11").value;
		...
		//	var para2 =[];
           ...
           for (var i = 0; i < arrayLength/4; i++) {
              ...
              var year = list[4*i];
              var month = list[4*i +1];
              var date = list[4*i +2];
              
              var time = gd(year,month,date);
              
           
              
              data1.push( [time, list[4*i +3]] );                    
...
FusionCharts.ready(function () {
	...
	var sexec = document.getElementById("sexec").value;
	var sse = document.getElementById("sse").value;
    ...
    var wealthChart = new FusionCharts({
        ...
        dataSource: {
            "chart": {
                ...
                "numberPrefix": "",
                "numberSuffix": "",
                "plotTooltext": "Percentage of $label is $value ",
                "showValues": "1",
                "chartLeftMargin": "10"
            },
            "data": [{
...
<script type="text/javascript" >
 ...
 $(document).ready(function () {
	...
	// var dataRed = [[6, 6, 10], [7, 5, 10], [8, 4, 10], [9, 3, 10], [10, 2, 10], [11, 1, 10]];
	  var dataRed =  ${RedList} ;
	  
	// var dataNeutral = [ [6, 7, 10], [7, 6, 10], [8, 5, 10], [9, 4, 10], [10, 3, 10], [11, 2, 10], [12, 1, 10] ];
	   var dataNeutral =  ${NeutralList} ;
	   
	// var dataGreen = [ [7, 7, 10], [8, 6, 10], [9, 5, 10], [10, 4, 10], [11, 3, 10], [12, 2, 10] ];
	 var dataGreen =  ${GreenList} ;
	    ...
	    $("#scatterGraph").highcharts({
	        ...
	        title: {
	         ...
	         xAxis: {
	            ...
	            categories: ['0','ASE','SE','SSE','TL','AM','M','SM']
	        }, 
	        
	       /*  xAxis: {
	            min: 1, categories: ['ASE', 'SE', 'SSE', 'TL','AM','M','SM']
	        },
 */
	        yAxis: {
	            startOnTick: false,
	        ...
	        series: [{
	            ...
	            marker: {
	                fillColor: {
	                    ...
	                    stops: [
	                        ...
	                        [1, Highcharts.Color(Highcharts.getOptions().colors[5]).setOpacity(1).get('rgba')]
	                    ] 
	                } 
	            }
	        }, {
	            ...
	            marker: {
	                fillColor: {
	                    ...
	                    stops: [
	                        [0, 'rgba(255,255,255,0.7)'],
	                        [1, Highcharts.Color(Highcharts.getOptions().colors[3]).setOpacity(0.7).get('rgba')]
	                    ]
	                }
	            }
	        },
	            ...
	            marker: {
	                fillColor: {
	                    ...
	                    stops: [
	                        ...
	                        [1, Highcharts.Color(Highcharts.getOptions().colors[2]).setOpacity(0.7).get('rgba')]
	                    ]
	                }
	            }
	        }
...
function addButton() {
	...
	// total emp change
    var text = "";
    text = document.getElementById("EmpCountChange").value ;
    var change = parseFloat(text);
    
    if(change<0)
    	{
    	var d = document.getElementById("totalEmpChangeColor");
    	d.className += " red";
  	
    	var d = document.getElementById("totalEmpChangelogo");
    	d.className += " fa fa-sort-desc";   	
    	}
	...
	var d = document.getElementById("totalEmpChangelogo");
	d.className += " fa fa-sort-asc";
	}
    //
    
    
    // ase count change
    text = document.getElementById("AseCountChange").value ;
 	var change = parseFloat(text);
    
    if(change<0)
    	{
    	var d = document.getElementById("aseChangeColor");
    	d.className += " red";
  	
    	var d = document.getElementById("aseChangelogo");
    	d.className += " fa fa-sort-desc";   	
    	}
    ...
    //
     ...
     // ase plus se count change
    text = document.getElementById("AsePlusSeCountChange").value ;
 	var change = parseFloat(text);
    
    if(change<0)
    	{
    	var d = document.getElementById("asePlusSeChangeColor");
    	d.className += " red";
  	
    	var d = document.getElementById("asePlusSeChangelogo");
    	d.className += " fa fa-sort-desc";   	
    	}
    ...
    // gcp count change
    text = document.getElementById("GcpCountChange").value ;
 	var change = parseFloat(text);
    
    if(change<0)
    	{
    	var d = document.getElementById("gcpChangeColor");
    	d.className += " red";
  	
    	var d = document.getElementById("gcpChangelogo");
    	d.className += " fa fa-sort-desc";   	
    	}
    ...
    // loaned count change
    text = document.getElementById("LoanedCountChange").value ;
 	var change = parseFloat(text);
    
    if(change<0)
    	{
    	var d = document.getElementById("loanChangeColor");
    	d.className += " red";
  	
    	var d = document.getElementById("loanChangelogo");
    	d.className += " fa fa-sort-desc";   	
    	}
    ...
    // diversity percentage change
    text = document.getElementById("DiversityPercentageChange").value ;
 	var change = parseFloat(text);
    
    if(change<0)
    	{
    	var d = document.getElementById("diversityChangeColor");
    	d.className += " red";
  	
    	var d = document.getElementById("diversityChangelogo");
    	d.className += " fa fa-sort-desc";   	
    	}
